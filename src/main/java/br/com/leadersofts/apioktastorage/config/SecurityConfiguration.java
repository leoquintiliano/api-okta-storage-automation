package br.com.leadersofts.apioktastorage.config;

import br.com.leadersofts.apioktastorage.auth.user.service.SecurityFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST,"/observacao").hasRole("ADMIN")
